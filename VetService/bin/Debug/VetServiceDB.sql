/*
Deployment script for VetServiceDB
...
:setvar DatabaseName "VetServiceDB"
:setvar DefaultFilePrefix "VetServiceDB"
:setvar DefaultDataPath "C:\Users\Dylan\AppData\Local\Microsoft\VisualStudio\SSDT\VetService"
:setvar DefaultLogPath "C:\Users\Dylan\AppData\Local\Microsoft\VisualStudio\SSDT\VetService"
...
('T1', 'Buster', 1, 01, '06/20/2017', 'Routine Vaccination', $22.00),
('T2', 'Buster', 1, 01, '05/15/2018', 'Booster Shot', $24.00),
('T3', 'Fluffy', 1, 10, '05/10/2018', 'Wounds sustained in apparent cat fight', $30.00),
('T4', 'Stew', 2, 10, '05/10/2018', 'Wounds sustained during attempt to cook the stew', $30.00),
('T5', 'Pooper', 3, 05, '05/18/2017', 'Routine Test', $25.00);
...
GO
ALTER TABLE [dbo].[Pet] WITH CHECK CHECK CONSTRAINT [FK_PET_ownID];

ALTER TABLE [dbo].[Treatment] WITH CHECK CHECK CONSTRAINT [FK_TREATMENT_ProcID];
